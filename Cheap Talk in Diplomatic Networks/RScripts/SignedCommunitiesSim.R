...
foo <- cluster_spinglass(thismonth_graph, implementation = 'neg')
V(thismonth_graph)$membership <- foo$membership
...
thismonth_cut <- add_edges(thismonth_cut, as.matrix(membership_mat))
plot(thismonth_cut)
