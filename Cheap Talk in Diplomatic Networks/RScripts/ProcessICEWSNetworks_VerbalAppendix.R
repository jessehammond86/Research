...
#   rootcode_year_data
#   , tie_weights = 'raw'
#   , exclude_codes = c(6, 7, 8, 14, 15, 17, 18, 19, 20)
#   , time_window = 'year'
#   , ties_normalize = 'state'
# )
## Goldstein-weighted
...
# save(yearly_arrays_raw, file = './Data/AppendixData/yearly_arrays_raw.Rdata')
save(yearly_arrays_gold, file = './Data/AppendixData/yearly_arrays_gold.Rdata')
