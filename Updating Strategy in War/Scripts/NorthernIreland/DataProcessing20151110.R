...
process_data <- function(x){
  test_out <- x[, list(
    ...
    , REPUBKILLSPOP = mean(TOTPOP[PERPFACTION == 'Republican'])
    , UNIONKILLSPOP = mean(TOTPOP[PERPFACTION == 'Union'])
    , STATEKILLSPOP = mean(TOTPOP[PERPFACTION == 'State'])
...
write.csv(ni_data, file = '/Users/jesse/Dropbox/Dissertation/Data/NorthernIreland/NI_quarter_deaths.csv', row.names = F)
write.csv(belfast_data, file = '/Users/jesse/Dropbox/Dissertation/Data/NorthernIreland/belfast_quarter_deaths.csv', row.names = F)
write.csv(rural_data, file = '/Users/jesse/Dropbox/Dissertation/Data/NorthernIreland/rural_quarter_deaths.csv', row.names = F)
