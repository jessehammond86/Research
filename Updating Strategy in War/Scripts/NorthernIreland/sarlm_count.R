...
ira_select <- lagsarlm(ira_select ~ 
                             LTUNEMP 
                           #+ BORDER
                           + PCTURBN
                           + DERRY
...
ira_select_urb <- lagsarlm(ira_select ~ 
                      LTUNEMP 
                    + PCTCATH 
                    + PCTCATHSQ
                    + POPDENS 
...
ira_select_rur <- lagsarlm(ira_select ~ 
                      LTUNEMP 
                    + PCTURBN
                    + PCTCATH 
                    + PCTCATHSQ
...
stargazer(ira_select, ira_select_urb, ira_select_rur)

######## INDISCRIMINATE IRA VIOLENCE
ira_indis <- lagsarlm(ira_indis ~ 
                         LTUNEMP 
                       #+ BORDER
                       + PCTURBN
                       + DERRY
...
ira_indis_urb <- lagsarlm(ira_indis ~ 
                             LTUNEMP 
                           + PCTCATH 
                           + PCTCATHSQ
                           + POPDENS 
...
ira_indis_rur <- lagsarlm(ira_indis ~ LTUNEMP 
                           + PCTURBN
                           + PCTCATH 
                           + PCTCATHSQ
                           + POPDENS 
...
stargazer(ira_indis, ira_indis_urb, ira_indis_rur)


######################################################################################################
######## SELECTIVE IRA VIOLENCE AGAINST CIVILIANS
ira_select_civ <- lagsarlm(ira_civ_sel ~ 
                         LTUNEMP 
                       #+ BORDER
                       + PCTURBN
                       + DERRY
...
ira_select_urb_civ <- lagsarlm(ira_civ_sel ~ 
                             LTUNEMP 
                           + PCTCATH 
                           + PCTCATHSQ
                           + POPDENS 
...
ira_select_rur_civ <- lagsarlm(ira_civ_sel ~ 
                             LTUNEMP 
                           + PCTURBN
                           + PCTCATH 
                           + PCTCATHSQ
...
stargazer(ira_select_civ, ira_select_urb_civ, ira_select_rur_civ)



######## INDISCRIMINATE IRA VIOLENCE AGAINST CIVILIANS
ira_indis_civ <- lagsarlm(ira_civ_ind ~ 
                        LTUNEMP 
                      #+ BORDER
                      + PCTURBN
                      + DERRY
...
ira_indis_urb_civ <- lagsarlm(ira_civ_ind ~ 
                            LTUNEMP 
                          + PCTCATH 
                          + PCTCATHSQ
                          + POPDENS 
...
ira_indis_rur_civ <- lagsarlm(ira_civ_ind ~ LTUNEMP 
                          + PCTURBN
                          + PCTCATH 
                          + PCTCATHSQ
                          + POPDENS 
...
stargazer(ira_indis_civ, ira_indis_urb_civ, ira_indis_rur_civ)

######## INDISCRIMINATE IRA VIOLENCE AGAINST MILITARY
ira_indis_mil <- lagsarlm(ira_mil_ind ~ 
                                LTUNEMP 
                              #+ BORDER
                              + PCTURBN
                              + DERRY
...
ira_indis_urb_mil <- lagsarlm(ira_mil_ind ~ 
                                    LTUNEMP 
                                  + PCTCATH 
                                  + PCTCATHSQ
                                  + POPDENS 
...
ira_indis_rur_mil <- lagsarlm(ira_mil_ind ~ LTUNEMP 
                                  + PCTURBN
                                  + PCTCATH 
                                  + PCTCATHSQ
                                  + POPDENS 
...
stargazer(ira_indis_mil, ira_indis_urb_mil, ira_indis_rur_mil)