...
ira_select_civ <- lagsarlm(ira_civ_sel_pct ~ 
                         LTUNEMP 
                       #+ BORDER
                       + PCTURBN
                       + DERRY
...
ira_select_urb_civ <- lagsarlm(ira_civ_sel_pct ~ 
                             LTUNEMP 
                           + PCTCATH 
                           + PCTCATHSQ
                           + POPDENS 
...
ira_select_rur_civ <- lagsarlm(ira_civ_sel_pct ~ 
                             LTUNEMP 
                           + PCTURBN
                           + PCTCATH 
                           + PCTCATHSQ
...
ira_indis_civ <- lagsarlm(ira_civ_ind_pct ~ 
                        LTUNEMP 
                      #+ BORDER
                      + PCTURBN
                      + DERRY
...
ira_indis_urb_civ <- lagsarlm(ira_civ_ind_pct ~ 
                            LTUNEMP 
                          + PCTCATH 
                          + PCTCATHSQ
                          + POPDENS 
...
ira_indis_rur_civ <- lagsarlm(ira_civ_ind_pct ~ LTUNEMP 
                          + PCTURBN
                          + PCTCATH 
                          + PCTCATHSQ
                          + POPDENS 
...
ira_indis_mil <- lagsarlm(ira_mil_ind_pct ~ 
                                LTUNEMP 
                              #+ BORDER
                              + PCTURBN
                              + DERRY
...
ira_indis_urb_mil <- lagsarlm(ira_mil_ind_pct ~ 
                                    LTUNEMP 
                                  + PCTCATH 
                                  + PCTCATHSQ
                                  + POPDENS 
...
ira_indis_rur_mil <- lagsarlm(ira_mil_ind_pct ~ LTUNEMP 
                                  + PCTURBN
                                  + PCTCATH 
                                  + PCTCATHSQ
                                  + POPDENS 
